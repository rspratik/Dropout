''''
Simple Standard MLP model
Activation Fn: Leaky relu with alpha=0.1
Cost Optimization Fn: Gradient Descent with learning = 0.05
'''
    ...
    with tf.Session() as sess:
        ...
        with tf.summary.FileWriter(cwd, sess.graph) as writer:
            ...
            for i in range(epochs):
                ...
                # save_path = saver.save(sess, "./mlp/simple/ckpoint/mlp.ckpt")
