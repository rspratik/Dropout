''''
Nested Dropout MLP model with weight decay: Dropout over the hidden layers would be applied stochastically.
...
cwd = "./mnist/mlp/dropout_nested_decay"
epochs = 50
p_keep_input = 1
p_keep_hidden = 0.6
...
def main():
    ...
    with tf.Session() as sess:
        ...
        #save_path = saver.save(sess, "./mlp/random_dropout_weight_decay/ckpoint/mlp.ckpt")
